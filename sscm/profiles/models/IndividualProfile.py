...
class IndividualProfile(MemberProfile):
    ...
    first_name = models.CharField(max_length=100, blank=True, verbose_name="Krstné meno")
    ...
    profession = models.CharField(max_length=500, blank=True, verbose_name="Zamestnanie")
    title_prefix = models.CharField(max_length=50, blank=True, verbose_name="Titul pred menom")
    title_suffix = models.CharField(max_length=50, blank=True, verbose_name="Titul za menom")
